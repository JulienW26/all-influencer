...
export const ui = {
  de: {
    ...
    instructions: [
      ...
      "Füge den Code in dein E-Mail-Tool ein (Brevo, Resend, etc.)"
    ],
    copied: "✅ Kopiert!",
  ...
  es: {
    ...
    instructions: [
      ...
      "Pega el código en tu herramienta de email (Brevo, Resend, etc.)"
    ],
    copied: "✅ ¡Copiado!",
...
export const templates = {
  ...
  en: {
    diamond: {
      ...
      model: [
        "333 spots worldwide – exclusively for the top 1% (1M+ followers). No mass market. Brands find the best.",
    ...
    gold: {
      ...
      highlight: "You're invited to join an exclusive group where quality, impact, and potential matter – not just follower count.",
  ...
  es: {
    diamond: {
      ...
      intro: "Tú construyes alcance. Tú entregas rendimiento. ¿Pero la riqueza? Termina en las plataformas.",
      ...
      model: [
        "333 spots en todo el mundo – exclusivamente para el top 1% (1M+ seguidores). Sin masas. Las marcas encuentran a los mejores.",
        "80% en efectivo de cada trato va directamente a ti.",
        "20% se convierte en acciones – construyes riqueza mientras trabajas.",
        "Protección anti-dilución: Creadores + Fundadores = mayoría permanente."
      ],
