    ...
    <>
      ...
      <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4">
        ...
        <div className="w-full max-w-md bg-gray-900 rounded-xl border border-gray-800 p-6 md:p-8">
          ...
          {step === 1 && (
            <>
              <h2 className="text-2xl font-bold text-white text-center mb-2">Einladungscode eingeben</h2>
              <p className="text-gray-400 text-center mb-6">Gib deinen persönlichen Einladungscode ein</p>
              ...
              <div className="mb-6">
                ...
                />
                <p className="mt-2 text-xs text-gray-500 text-center">IN-Codes für Influencer • BR-Codes für Brands</p>
              </div>
          ...
          {step === 2 && codeType === 'brand' && (
            <>
              <h2 className="text-2xl font-bold text-white text-center mb-2">Brand Registrierung</h2>
              <p className="text-gray-400 text-center mb-6">Registriere dein Unternehmen</p>
              ...
              <form onSubmit={handleBrandSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input type="tel" value={brandData.phone} onChange={(e) => setBrandData({...brandData, phone: e.target.value})} className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-400" placeholder="+49 123 456789" />
                </div>
                ...
                <div>
                  ...
                  <input type="url" value={brandData.website} onChange={(e) => setBrandData({...brandData, website: e.target.value})} className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-400" placeholder="https://firma.com" />
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Kurze Beschreibung</label>
                  <textarea value={brandData.description} onChange={(e) => setBrandData({...brandData, description: e.target.value})} rows={3} className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-400 resize-none" placeholder="Was macht Ihr Unternehmen?" />
                </div>
        ...
        {step !== 3 && (
          <div className="mt-6 flex flex-col items-center space-y-2">
            {step === 2 && (
              <button onClick={() => setStep(1)} className="text-sm text-gray-500 hover:text-gray-300">← Anderen Code eingeben</button>
            )}
            <Link href="/portal/login" className="text-sm text-amber-400 hover:text-amber-300">Bereits registriert? Anmelden</Link>
          </div>
        )}
      </div>
    </>
